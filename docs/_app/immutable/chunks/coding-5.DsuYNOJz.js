import{a as p,t as l}from"./disclose-version.yFYzY67q.js";import"./legacy.CQzi9stk.js";import{i as o,j as e}from"./runtime.DNrlAA3c.js";import{h as t}from"./html.gT-yHAVe.js";const y={title:"coding-5",description:"Kattis - mali",date:"2025-01-31T00:00:00.000Z",tags:["daily-coding"],published:!0};var c=l("<h2>Kattis – mali</h2> <p>The basic algorithm is easy to spot, the hard part is figuring out a way to get it under the time limit. We just need to exploit the fact that the numbers given is under 100.</p> <p>What’s weird however, is that the bookkeeping for <code>tempA</code> and <code>tempB</code> (zeroing) is needed for the solution to be correct? From my understanding, we never touch them again aside from the ones that doesn’t involve zeroing. Maybe it’s just some corner case.</p> <p><strong>My solution:</strong></p> <!>",1);function i(a){var s=c(),n=o(e(s),8);t(n,()=>`<pre class="shiki poimandres" style="background-color:#1b1e28;color:#a6accd" tabindex="0"><code><span class="line"><span style="color:#A6ACCD">#include </span><span style="color:#A6ACCD">&#x3C;</span><span style="color:#5DE4C7">bits/stdc++.h</span><span style="color:#A6ACCD">></span></span>
